 ...
 * 
 * 使用方法：
 * bun scripts/test-sms-registration.ts +8617098891650 APPROVED
 * bun scripts/test-sms-registration.ts +8617098891650 REJECTED
 */
...
async function testSMSRegistration() {
	...
	if (args.length < 2) {
		console.error("使用方法: bun scripts/test-sms-registration.ts <手机号> <状态>");
		console.error("示例: bun scripts/test-sms-registration.ts +8617098891650 APPROVED");
