...
async function runFullAnalysis() {
	...
	results.details.english.missing = runCommand(
		"npx i18n-check --locales packages/lib-shared/src/i18n/translations --source en --format next-intl --only missingKeys",
		"Missing English translations",
		"en-missing.txt",
	);

	results.details.english.unused = runCommand(
		"npx i18n-check --locales packages/lib-shared/src/i18n/translations --source en --format next-intl --only unused --unused apps/web/src",
		"Unused English translations",
		"en-unused.txt",
	);

	results.details.english.summary = runCommand(
		"npx i18n-check --locales packages/lib-shared/src/i18n/translations --source en --format next-intl --reporter summary",
	...
	results.details.chinese.fullCheck = runCommand(
		"npx i18n-check --locales packages/lib-shared/src/i18n/translations --source zh --format next-intl",
		"Complete Chinese check",
		"zh-full-check.txt",
	);

	results.details.chinese.missing = runCommand(
		"npx i18n-check --locales packages/lib-shared/src/i18n/translations --source zh --format next-intl --only missingKeys",
		"Missing Chinese translations",
		"zh-missing.txt",
	);

	results.details.chinese.summary = runCommand(
		"npx i18n-check --locales packages/lib-shared/src/i18n/translations --source zh --format next-intl --reporter summary",
...
\`\`\`bash
pnpm run i18n:analyze    # Full comprehensive analysis
pnpm run i18n:check      # Quick English validation
\`\`\`
`;
}
