...
function printHelp() {
	console.log(`Usage: bun scripts/test-email.ts [options] [to] [subject] [message]
...
Examples:
  bun scripts/test-email.ts
  bun scripts/test-email.ts teammate@example.com "Quick test"
  bun scripts/test-email.ts --to teammate@example.com --text "Line 1\\nLine 2"
  bun scripts/test-email.ts --html '<strong>Hello</strong>'
`);
}
