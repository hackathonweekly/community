...
import { EmailComposerForm } from "@/modules/dashboard/emails/components/EmailComposerForm";
import type { EmailTemplateOption } from "@/modules/dashboard/emails/components/EmailComposerForm";
	...
	return (
		<div className="p-6 space-y-6">
			...
			<div>
				...
				<p className="text-gray-600 mt-2">向组织成员发送通知邮件</p>
			</div>
				...
				<CardContent>
					<div className="grid grid-cols-1 gap-4 md:grid-cols-3">
						...
						<div className="text-center">
							...
							<p className="text-sm text-gray-500">普通成员</p>
						</div>
					</div>
			...
			<Card>
				<CardHeader>
					...
					<CardDescription>
						根据角色或成员等级筛选收件人，未选择时默认发送给所有有邮箱的成员。
					</CardDescription>
				</CardHeader>
				<CardContent>
					<div className="grid gap-4 md:grid-cols-2">
						...
						<div>
							<Label className="mb-1 block">成员等级</Label>
							<Select
