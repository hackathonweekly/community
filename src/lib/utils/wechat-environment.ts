 ...
 * 获取微信环境信息
 */
export function getWeChatEnvironmentInfo(): WeChatEnvironmentInfo {
 ...
 * 获取微信登录的provider ID
 */
export function getWeChatProviderId(): WeChatProviderType {
	return getWeChatEnvironmentInfo().recommendedProvider;
}
