		...
		<div className="space-y-4">
			...
			>
				{PROJECT_STAGE_OPTIONS.map((option) => {
					...
					const isHovered = hoveredStage === option.value;

					return (
						<div
							key={option.value}
							className="relative"
							onMouseEnter={() => setHoveredStage(option.value)}
						...
						>
							...
							{(isHovered || isSelected) && (
								<div className="relative left-1/2 transform -translate-x-1/2 mt-2 z-10 px-3 py-2 bg-gray-900 text-white text-xs rounded-lg shadow-lg whitespace-nowrap w-fit">
									{option.description}
