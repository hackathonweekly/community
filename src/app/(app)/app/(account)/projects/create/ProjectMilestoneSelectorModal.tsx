							...
							{MILESTONE_OPTIONS.map((milestone) => {
								...
								return (
									...
									>
										...
										{/* Tooltip */}
										{isHovered && (
											<div className="absolute top-full left-1/2 transform -translate-x-1/2 mt-1 z-10 px-2 py-1 bg-gray-900 text-white text-xs rounded shadow-lg whitespace-nowrap max-w-xs">
