...
import { getInvitation, getSession } from "@dashboard/auth/lib/server";
import { InvitationProfileCompletionForm } from "@dashboard/organizations/components/InvitationProfileCompletionForm";
import { redirect } from "next/navigation";
import { withQuery } from "ufo";

function buildInvitationPath(invitationId: string) {
	return `/app/organization-invitation/${invitationId}`;
}
