...
import { OrganizationInvitationModal } from "@dashboard/organizations/components/OrganizationInvitationModal";
	...
	if (!session) {
		return redirect(
			withQuery("/auth/login", {
				invitationId,
				redirectTo: `/app/organization-invitation/${invitationId}`,
			}),
		);
	}
