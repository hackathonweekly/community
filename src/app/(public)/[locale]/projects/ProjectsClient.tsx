...
import { useProjects, usePrefetchProjects } from "./hooks/useProjectQueries";
...
export function ProjectsClient({
	...
	return (
		<div className="container max-w-7xl pt-8 pb-32 md:pb-16 px-4 sm:px-6 lg:px-8">
			{!hidePageHero && (
				<PageHero
					title={t("title")}
					description={t("description")}
					actions={
						showCreateButton && session?.user ? (
