...
import {
	...
	HoverCardContent,
	HoverCardTrigger,
} from "@community/ui/ui/hover-card";
import { getLevelInfo } from "@community/lib-shared/level-utils";
...
export function UserLevelBadges({
	...
	// 仅依据 membershipLevel 展示基础身份；未设置时按新朋友处理，避免误判为伙伴
