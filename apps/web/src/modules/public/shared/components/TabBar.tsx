...
import {
	...
	getMobileHomeHref,
	getUserTabKeys,
} from "@/modules/public/shared/lib/mobile-entry-policy";
...
export function TabBar() {
	...
	const tabKeys = user ? getUserTabKeys() : getGuestTabKeys();

	const tabConfig: Record<TabKey, Tab> = {
		home: {
			name: t("tab_nav.discover"),
	...
	const tabItems = tabKeys.map((tabKey) => tabConfig[tabKey]);
