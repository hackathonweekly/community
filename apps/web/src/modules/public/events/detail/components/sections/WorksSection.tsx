...
export function WorksSection({
	...
	const works: Work[] = projectSubmissions.map((submission) => {
		...
		const href = submission.id
			? `/events/${eventId}/submissions/${submission.id}`
			: project?.id
				? `/projects/${project.shortId || project.id}`
	...
	const submissionHref = userSubmission
		? `/events/${eventId}/submissions`
		: `/events/${eventId}/submissions/new`;
	const unauthenticatedSubmissionHref = `/events/${eventId}/submissions`;
