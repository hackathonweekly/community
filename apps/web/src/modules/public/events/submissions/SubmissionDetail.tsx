...
import { AudioPlayer } from "@community/ui/ui/audio-player";
import { Avatar, AvatarFallback, AvatarImage } from "@community/ui/ui/avatar";
import { Badge } from "@community/ui/ui/badge";
import { Button } from "@community/ui/ui/button";
import { Dialog, DialogClose, DialogContent } from "@community/ui/ui/dialog";
...
export function SubmissionDetail({
	...
	const registerHref = `/events/${submission.eventId}/register`;
		...
		<div className="min-h-[calc(100vh-80px)] w-full rounded-3xl overflow-hidden border border-slate-800 bg-slate-950 text-slate-100 shadow-2xl">
			...
			<div className="relative z-10 flex flex-col h-full">
				...
				<div className="flex items-center justify-between p-4 md:p-6 border-b border-white/5 bg-white/5 backdrop-blur-md">
					...
					>
						<Link
							href={`/events/${submission.eventId}/submissions`}
						>
					...
					<div className="flex items-center gap-2">
						{isLeader && (
							...
							>
								<Link
									href={`/events/${submission.eventId}/submissions/${submission.id}/edit`}
								>
									管理作品
								</Link>
							</Button>
						...
						<Button
							...
							onClick={() =>
								router.push(
									`/events/${submission.eventId}/submissions/slides?start=${submission.id}`,
								)
							}
						>
