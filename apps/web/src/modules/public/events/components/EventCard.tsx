		...
		>
			...
			>
				...
				<div className="flex flex-1 flex-col p-3">
					...
					{event.series ? (
						<div className="mb-2">
							<span className="inline-flex rounded-md border border-border/70 bg-muted/40 px-2 py-0.5 text-[10px] font-semibold text-muted-foreground">
								系列：{event.series.title}
							</span>
						</div>
					) : null}
