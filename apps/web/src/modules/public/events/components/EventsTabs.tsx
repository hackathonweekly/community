...
import { VisitorLoginBanner } from "@/modules/public/shared/components/VisitorLoginBanner";
import { shouldShowVisitorLoginBanner } from "@/modules/public/shared/lib/mobile-entry-policy";
	...
	if (!isAuthenticated) {
		...
		return (
			<div className="w-full">
				...
				{shouldShowVisitorLoginBanner(isAuthenticated) ? (
					<VisitorLoginBanner
