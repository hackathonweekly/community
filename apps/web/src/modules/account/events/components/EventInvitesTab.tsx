...
import type { EventInviteWithStats } from "@community/lib-server/database";
...
const NEW_USER_THRESHOLD_DISPLAY_CLASS = "text-primary";
...
export function EventInvitesTab({ eventId }: EventInvitesTabProps) {
	...
	const buildShareUrl = useCallback(
		(code: string) => `${origin}/events/${eventId}?invite=${code}`,
