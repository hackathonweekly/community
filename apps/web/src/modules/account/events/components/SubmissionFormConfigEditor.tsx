...
import { DEFAULT_WORK_AUTHORIZATION_AGREEMENT_MARKDOWN } from "@community/lib-shared/events/event-work-agreements";
						...
						{fields.map((field, index) => (
							...
							>
								...
								<AccordionContent className="space-y-4 pt-3">
									<div className="flex flex-col gap-3 rounded-md border bg-muted/50 px-3 py-2 sm:flex-row sm:flex-wrap sm:items-center sm:justify-between">
