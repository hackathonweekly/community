		...
		<Dialog open={isOpen} onOpenChange={handleClose}>
			<DialogContent className="sm:max-w-md max-w-[95vw] mx-auto">
				...
				<div className="flex flex-col items-center space-y-4">
					...
					<div className="relative mx-auto w-64 h-64 bg-muted rounded-lg border-2 border-border">
						{/* Loading State */}
						{isLoading && (
								...
								<div className="space-y-2">
									...
									<div className="flex gap-2">
										<input
											...
											className="flex-1 px-3 py-2 text-sm border rounded-md focus:outline-none focus:ring-2 focus:ring-primary focus:border-primary"
											onKeyDown={(e) => {
												if (e.key === "Enter") {
													handleManualInput();
												}
