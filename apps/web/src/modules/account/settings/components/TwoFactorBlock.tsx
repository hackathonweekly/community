...
import { FormItem } from "@community/ui/ui/form";
import { Input } from "@community/ui/ui/input";
import { Label } from "@community/ui/ui/label";
import { PasswordInput } from "@community/ui/ui/password-input";
import {
	ArrowRightIcon,
	CheckIcon,
	ShieldCheckIcon,
...
export function TwoFactorBlock() {
	...
	if (!accountList.some((account) => account.provider === "credential")) {
		return null;
	}
