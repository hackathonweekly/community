...
export const EventScalarFieldEnumSchema = z.enum(['id','shortId','title','shortDescription','richContent','contentImages','organizerId','type','status','seriesId','startTime','endTime','timezone','isOnline','address','organizationId','onlineUrl','isExternalEvent','externalUrl','maxAttendees','registrationDeadline','requireApproval','registrationSuccessInfo','registrationSuccessImage','registrationPendingInfo','registrationPendingImage','registrationFieldConfig','coverImage','tags','featured','volunteerContactInfo','volunteerWechatQrCode','organizerContact','templateId','requireProjectSubmission','projectSubmissionDeadline','askDigitalCardConsent','submissionsEnabled','hackathonConfig','registrationOpen','submissionsOpen','votingOpen','showVotesOnGallery','feedbackConfig','submissionFormConfig','viewCount','createdAt','updatedAt']);

export const EventSeriesScalarFieldEnumSchema = z.enum(['id','slug','title','description','richContent','coverImage','logoImage','tags','organizerId','organizationId','isActive','createdAt','updatedAt']);

export const EventSeriesSubscriptionScalarFieldEnumSchema = z.enum(['id','seriesId','userId','notifyEmail','notifyInApp','createdAt','updatedAt']);
...
/////////////////////////////////////////
// EVENT SERIES SUBSCRIPTION SCHEMA
/////////////////////////////////////////

export const EventSeriesSubscriptionSchema = z.object({
  id: z.cuid(),
  seriesId: z.string(),
  userId: z.string(),
...
export type EventSeriesSubscription = z.infer<typeof EventSeriesSubscriptionSchema>
