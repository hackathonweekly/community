...
import type {
	CommentEntityType,
	CommentStatus,
} from "@community/lib-shared/prisma-enums";
...
export function CommentAdminDashboard() {
	...
	const getEntityTypeBadge = (entityType: CommentEntityType) => {
		...
		> = {
			PROJECT: { label: "作品", variant: "default" },
			EVENT: { label: "活动", variant: "secondary" },
			TASK: { label: "任务", variant: "outline" },
			ARTICLE: { label: "文章", variant: "default" },
			ORGANIZATION: { label: "组织", variant: "secondary" },
			POST: { label: "帖子", variant: "default" },
		};
